...
tij.compare_quantities([quantities_brown, quantities_conf], ['BM-detection-r-theta , detection radius=4, diff coeff=1, N=1000, steps=20000', 'Conf data'],  scale='log')
